...
export const roastProfiles = {
  filip: {
    persona: 'Make Golf-CEO som tycker han är pro men slår OB hela tiden',
    soreSpots: [
      'Long Gone-nick (alltid OB, alltid borta från fairway)',
      'Make Golf-CEO men ser ut som en weekend-warrior',
      'förlorade 2025-finalen till Matthis (en arbetslös)',
      'pratar alltid om Make Golf på range trots att ingen frågat',
      'HCP 8.6 men spelar som 18.5',
    ],
    forbidden: ['hans dotter', 'familj'],
    tone: 'lite avundsjuk: spelarna spelar med sin egen CEO',
  },
  matthis: {
    persona: 'arbetslös Pro Am-wannabe (THE GRINDER) som har all tid att grinda men ingen riktig grind',
    soreSpots: [
      'ARBETSLÖS — har all tid i världen att golfa',
      'Pro Am-nick: amatör som tror han är pro',
      'försökte vinna 2025 men det var en lucky shot',
      'jobbsöker fortfarande efter ett år',
      'fakar Spotify Premium för att inte betala',
      'kommer på rangen klockan 10 på en tisdag (för att fan vad ska han annars göra)',
    ],
    forbidden: [],
    tone: 'brutal — han ska få mest skit. ARBETSLÖS-jokes räcker långt',
  },
  martin: {
    persona: 'Plus One-rookie HCP 40 med kommunistiska tendenser (intern joke)',
    soreSpots: [
      'HCP 40 (rookie cap, kan inte gå högre)',
      'kommunistiska tendenser (intern joke — han hatar kapitalism men älskar Hooks Spa)',
      'spelade exakt två rundor 2019, sen ingen golf',
      'Plus One-nick: alltid ett slag bakom alla',
      'kanske egentligen är dansk',
    ],
    forbidden: [],
    tone: 'mjuk men ironisk — han är rookien, ge honom credit för att han ens dyker upp',
  },
  marcus: {
    persona: 'Five o\'Clock — analytisk spreadsheet-nörd som kan stableford men 3-puttar greener',
    soreSpots: [
      'Five o\'Clock-nick (klockslag, inte exemplary)',
      'vann 2021 men ingen pratar om det längre',
      'har Excel för sina egna stats',
      'kan stableford-tabellen utantill men 3-puttar varje rond',
      'tar 12 minuter att välja klubba på en par 3',
    ],
    forbidden: [],
    tone: 'analytisk roast — räkna hans 3-putts statistiskt',
  },
  fredrik: {
    persona: 'The Fossil — gammal old fashioned-drinkare som glömmer sin score från förra hålet',
    soreSpots: [
      'The Fossil-nick (verkligen fossil)',
      'HCP 22.3 men säger "jag är runt 15"',
      'glömmer score från förra hålet',
      'beställer Old Fashioned innan hål 1',
      'sista att lämna 19th hole, alltid',
    ],
    forbidden: [],
    tone: 'whisky-soaked roast — referera drycker',
  },
  magnus: {
    persona: 'The Hybrid — snålaste miljonären, slår bara hybrid-slag, köper aldrig en runda',
    soreSpots: [
      'AS RIK men SNÅLASTE — köper aldrig en runda',
      'The Hybrid-nick (slår bara hybrid, vågar inte driver)',
      'Plan B-tendens (Plan A var Marcus 2021)',
      'vann 2024 men på en svag turnering',
      'har en miljon i banken men säger "kanske vi splittar?"',
    ],
    forbidden: [],
    tone: 'pengar-jokes — han har råd, han bara vägrar',
  },
  rami: {
    persona: 'Säpo — låg profil, ingen vet vad han egentligen jobbar med, dök upp 2026',
    soreSpots: [
      'Säpo-nick (extremt lågprofil, ingen vet något)',
      'HCP 23.7 (försöker bli bättre)',
      'är ny i gänget, har inte intjänat respekt än',
      'svarar aldrig direkt på vad han jobbar med',
    ],
    forbidden: [],
    tone: 'mystisk roast — spinna på att han är agent eller spion',
  },
}
...
export function buildRoastPrompt(targetPlayer, recentStats, fromPlayer) {
  ...
  return `Du är en brutal men kul vän i DIO-gänget (Douche Invitational Only). Du roastar ${targetPlayer.name} ("${targetPlayer.nickname}", HCP ${targetPlayer.hcp}) på beställning av ${fromPlayer?.nickname || 'någon i gänget'}.

OFFRETS PERSONLIGHET: ${profile.persona}

SORE SPOTS du kan dra (välj 1-2 max):
${profile.soreSpots.map(s => `- ${s}`).join('\n')}
...
- Använd nicknamen ("${targetPlayer.nickname}")
- Var specifik — referera EN sak (sore spot eller live-data)
- INGEN positiv slutkläm, ingen "men du är ändå grym"
- Brutal humor, inte elak. Internt skämt-vibes.
- Inga emojis
- Inga klyschor som "haha" eller "lol"
