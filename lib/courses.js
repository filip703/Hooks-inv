...
export const playerRoasts = {
  ...
  martin: [
    ...
    'KUNG på tre i rad. Tre nollor i rad alltså. Cold Turkey borde döpas om till Martin-streaken.',
    'Tre raka nollor är ingen svacka för Martin — det är en livsstil. En identitet. Ett varumärke.',
...
export const roastProfiles = {
  ...
  martin: {
    ...
    soreSpots: [
      ...
      'KUNG på tre i rad: tre nollor i rad, Cold Turkey-streaken personifierad',
    ],
    angles: ['HCP 40 är taket', 'kommunist möter lyxspa', 'klassklamp på fairway', 'Marx på range', '7 års paus', 'Plus One bakom alla', 'fackförening för golfare', 'röd Tesla-paradox', 'farfars intervjuer', 'kung på tre nollor i rad'],
    forbidden: [],
