...
// Spotify – deeplink opens app, fallback opens web
function sp(id, song, artist, day) {
  return { day, song, artist, deep: `spotify:track:${id}`, url: `https://open.spotify.com/track/${id}` }
}
export const walkupMusic = {
  ...
  matthis: [sp('003vvx7Niy0yvhvHt4a68B','Mr. Brightside','The Killers','Fredag'), sp('4KV2M0cqETzpBEfCTsM7kK','Somebody Told Me','The Killers','Lördag'), sp('1Ov37jtRQ2YNAe8HzfczkL','Human','The Killers','Söndag')],
  magnus: [sp('26gFMjSEBBJDFBLYqVLHul',"Surfin' U.S.A.",'Beach Boys','Fredag'), sp('3EsUBG7lHTJgan460ypJbMJ','Kokomo','Beach Boys','Lördag'), sp('5t9KYe0Fhd5cW6UYT4qP8f','Good Vibrations','Beach Boys','Söndag')],
  marcus: [sp('5QLhGjKVFhJb8Aq1GJmKXE','Sabotage','Beastie Boys','Fredag'), sp('0sFnBif5zwBimPNJvrDOmN','Fight For Your Right','Beastie Boys','Lördag'), sp('5fpizYOjMUbGMTyjtVMXMw','Intergalactic','Beastie Boys','Söndag')],
  fredrik: [sp('3XVozq1aeqsJwpXrEZrDJ9','Ice Ice Baby','Vanilla Ice','Fredag'), sp('2fuCquhmrzHpu5xcA1ci9x','Under Pressure','Queen & Bowie','Lördag'), sp('4MRMEOg3AYeRWBm0A8MZdK','Cold as Ice','Foreigner','Söndag')],
  martin: [sp('2KH16WveTQWT6KOG9Rg6e2','Eye of the Tiger','Survivor','Fredag'), sp('4bHsxqR3GMrXTxEPLuK5ue',"Don't Stop Believin'",'Journey','Lördag'), sp('0kBbtU1H0RFMIlbWMCaVfl','Gonna Fly Now','Rocky Theme','Söndag')],
}
