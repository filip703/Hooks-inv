...
export const playerRoasts = {
  filip: [
    'ADHD:n märks redan på första tee – regler är inte till för alla.',
    'Slår gärna rakt men inte så ofta. En lyckad thai-spinner hellre än par.',
    'Slår längst i gänget. När allt stämmer är han svårslagen. Tyvärr stämmer det sällan.',
    'Bygger en app istället för att träna putt. Prioriteringar.',
    'Driver green ibland. Missar putten alltid. Bygger en AI-caddie istället.',
    'Har excel för allt utom sin egen swing. Den är beyond repair.',
  ],
  matthis: [
    'Ett under att han klarar sig i livet med färre kromosomer. Ex-säljare som tar sig själv på allt för stort allvar.',
    'Har lagt hundratals timmar på att träna golf. Trist att det inte hjälper.',
    'Den högst värderade deltagaren – i sin egen fantasi. Klart sämst i verkligheten.',
    'Utan Matthis ingen mening med livet. Enligt Matthis. Resten av oss klarar oss fint.',
    'Levererar alltid när det gäller. Gäller bara aldrig på golfbanan.',
    'G&T – Gin & Trippelbogey. Dricker det ena, spelar det andra.',
  ],
  marcus: [
    'Tävlingsledaren med Excel i blodet och regler i ryggraden – fram till första ölen.',
    'Tävlingsdjävulen lämnar fortare än han hittar vatten som inte ens finns.',
    'Den säkraste golfaren i gänget som sällan missar stort. Tråkigt men effektivt.',
  ...
  fredrik: [
    'Äldst men det märks inte i bunkern där han stannar några extra slag likt en treåring på stranden.',
    'Åldermannen uppskattas av alla och är ofta först till biran. Prioriteringar.',
    ...
    'Kan göra en 8:a utan att ändra ansiktsuttryck. Imponerande på fel sätt.',
  ],
  magnus: [
    'Duktig som få på mycket men kanske inte på golf. Tar hellre en bärs än slår en rak 6:a.',
    'Kan bomba sin hybrid lika bra som DeChambeau slår sin 8:a. Resten är sämre.',
    'Beach Boy – mer strandkänsla än golfkänsla. Tyvärr finns det ingen strand på Hooks.',
    'Dricker öl som andra dricker vatten. Spelar golf som andra kör go-kart.',
    'Bäst i laget på att hitta bunkrar. Ingen har bett honom om det.',
    'Magnus spelar inte golf. Golf spelar Magnus.',
  ],
  martin: [
    'Lillebror i dubbel bemärkelse – kämpar tappert i bakvattnet.',
    'Hoppas gå runt 18 hål utan att märkas för mycket. På hål 19 finns goda chanser för lika dålig humor som golf.',
    'Det ena uppskattas mer än det andra. Spoiler: det är inte golfen.',
    ...
    'Eye of the Tiger som walk-up. Mer som Eye of the Bogey i verkligheten.',
  ],
}
