...
export const roastProfiles = {
  ...
  matthis: {
    ...
    angles: ['arbetslöshets-skämt', 'mellan jobb-eufemismer', 'LinkedIn open-to-work', 'lucky 2025-vinst', 'Magnus betalar', 'Pro Am-amatörism', 'tisdag 10:00 på range', 'sov över hos andra'],
    forbidden: [],
  ...
  martin: {
    ...
    angles: ['HCP 40 är taket', 'kommunist möter lyxspa', 'klassklamp på fairway', 'Marx på range', '7 års paus', 'Plus One bakom alla', 'fackförening för golfare', 'röd Tesla-paradox'],
    forbidden: [],
  ...
  marcus: {
    ...
    angles: ['Excel-överanalys', '3-putt-stats', 'klubbval-paralys', '12 minuters tankegång', '2021-vinsten är gammal', 'h2h-spreadsheet', 'modeller säger han borde vinna', 'analytiker som glömmer kärnan'],
    forbidden: [],
  ...
  fredrik: {
    ...
    angles: ['Old Fashioned-räkning', 'minnesförlust på fairway', 'Royal Birkdale -86', 'fossil-teknologi', 'glasögon på pannan', 'progressiv golf "förstör spelet"', 'aldrig vinst men alltid med', '19th hole-mästare'],
    forbidden: [],
  ...
  magnus: {
    ...
    angles: ['snålhet vs rikedom', 'happy hour på spa', 'gamla Volvo-skenet', 'Tradera-fynd', 'Bingolotto-vinstrader', 'Swish 17 kr-skuld', 'Plan B-existens', '2024-vinsten var svag', 'matthis betalar för Magnus'],
    forbidden: [],
