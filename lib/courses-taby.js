...
// GPS coordinates per hole — sourced from OpenStreetMap Overpass API
// Verified against Täby GK banguide tee 60 distances (accuracy ~ ±30m on some doglegs)
// Format: { tee: {lat,lng}, green: {lat,lng}, hazards: [{type, lat, lng, desc}] }
export const TABY_GPS = {
  1: { tee: { lat: 59.501152, lng: 18.0143726 }, green: { lat: 59.5044843, lng: 18.011265 }, hazards: [] },
  2: { tee: { lat: 59.5040291, lng: 18.0104552 }, green: { lat: 59.5073478, lng: 18.0100435 }, hazards: [] },
  3: { tee: { lat: 59.5063182, lng: 18.0111008 }, green: { lat: 59.5039465, lng: 18.0142236 }, hazards: [] },
  4: { tee: { lat: 59.5044265, lng: 18.0140261 }, green: { lat: 59.5045905, lng: 18.0163811 }, hazards: [] },
  5: { tee: { lat: 59.5048394, lng: 18.017211 }, green: { lat: 59.5044205, lng: 18.0232193 }, hazards: [] },
  6: { tee: { lat: 59.5051726, lng: 18.0242364 }, green: { lat: 59.5016562, lng: 18.0208236 }, hazards: [] },
  7: { tee: { lat: 59.5026877, lng: 18.0192042 }, green: { lat: 59.501136, lng: 18.0199413 }, hazards: [] },
  8: { tee: { lat: 59.5010143, lng: 18.0182896 }, green: { lat: 59.504309, lng: 18.016915 }, hazards: [] },
  9: { tee: { lat: 59.5040649, lng: 18.0158673 }, green: { lat: 59.5012402, lng: 18.015088 }, hazards: [] },
  10: { tee: { lat: 59.5008049, lng: 18.015099 }, green: { lat: 59.5006517, lng: 18.0215685 }, hazards: [] },
  11: { tee: { lat: 59.5009508, lng: 18.0207438 }, green: { lat: 59.5026183, lng: 18.0260012 }, hazards: [] },
  12: { tee: { lat: 59.5029592, lng: 18.0257179 }, green: { lat: 59.5070666, lng: 18.0240262 }, hazards: [] },
  13: { tee: { lat: 59.5072548, lng: 18.0255256 }, green: { lat: 59.5048868, lng: 18.0269193 }, hazards: [] },
  14: { tee: { lat: 59.5046722, lng: 18.0275497 }, green: { lat: 59.506153, lng: 18.0286548 }, hazards: [] },
  15: { tee: { lat: 59.5051754, lng: 18.0288126 }, green: { lat: 59.5027114, lng: 18.0271425 }, hazards: [] },
  16: { tee: { lat: 59.5025196, lng: 18.0270657 }, green: { lat: 59.5006571, lng: 18.0222677 }, hazards: [] },
  17: { tee: { lat: 59.5006317, lng: 18.0231279 }, green: { lat: 59.4993122, lng: 18.0225937 }, hazards: [] },
  18: { tee: { lat: 59.4996354, lng: 18.0218492 }, green: { lat: 59.5006294, lng: 18.0144031 }, hazards: [] },
}
...
export function distanceToGreen(lat, lng, holeNum) {
  ...
  return Math.round(haversineDistance(lat, lng, gps.green.lat, gps.green.lng))
}

export function distanceToTee(lat, lng, holeNum) {
  const gps = TABY_GPS[holeNum]
  if (!gps?.tee?.lat) return null
  return Math.round(haversineDistance(lat, lng, gps.tee.lat, gps.tee.lng))
}
